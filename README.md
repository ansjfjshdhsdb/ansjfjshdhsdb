<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=30&pause=1000&color=00FF99&center=true&vCenter=true&width=600&lines=Python+Developer;UKRAINE+RP+Bots+Creator;Game+API+Enthusiast;Reverse+Engineering+Explorer" alt="Typing SVG" />
</div>

<h3 align="center">Код, API и автоматизация</h3>

---

### Обо мне

Я Python-разработчик с глубоким интересом к игровым API, бэкенду и внутреннему устройству игр. От создания сложных ботов до реверс-инжиниринга — я люблю разбирать системы на части и заставлять их работать по моим правилам.
...
*   ⚙️ **Интересы:** Игровые API, реверс-инжиниринг (Unity, хукинг, анализ памяти), обход клиентских ограничений и работа с бинарниками.
...
<div align="center">
  <sub><i>(paid messages, 1 star per one)</i></sub>
</div>
